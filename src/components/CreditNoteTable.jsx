...
export const CreditNoteTable = ({ selectedNote, setAssignedNote }) => {
  ...
  return (
    <>
      <h1 className='mt-10 mb-4 text-lg font-bold leading-none tracking-tight text-gray-500 md:text-5xl lg:text-2xl dark:text-black'>Notas de credito asociadas a la factura</h1>
          ...
          <table className='min-w-full divide-y divide-gray-200'>
            ...
            <tbody className='divide-y divide-gray-200'>
              {selectedNote && selectedNote.length > 0 ? (
                ...
                <tr>
                  <td className='px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap'>No hay notas de credito asociadas</td>
                </tr>
              )}
            </tbody>
          </table>
